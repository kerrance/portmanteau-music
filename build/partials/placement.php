...
?> ><div class="col-xs-12 col-sm-6"> <?php
    ...
    ?> <dl><dt>Project</dt><dd><?php echo $project ?></dd><dt>Client</dt><dd><?php echo $client ?></dd><dt>Placement</dt> <?php foreach($placements as $placement) {
