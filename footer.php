        ...
        <div class="limit">
        	...
        	<span style="float: right">
        		...
        		<dl>
					<dt>Email</dt>
					<dd><a href="mailto: info@portmanteaumusic.com">info@portmanteaumusic.com</a></dd>
					<dt>Twitter</dt>
					<dd><a href="http://twitter.com/PortmanteauUK" target="_blank">@PortmanteauUK</a></dd>
					<dt>Phone</dt>
					<dd>+44 (0) 1603 632466</dd>
					<dt>Address</dt>
					<dd>1 St. Augustines Gate<br>Norwich<br>NR3 3BE<br>United Kingdom</dd>
				</dl> 
        	</span>
        </div>
        </div>
